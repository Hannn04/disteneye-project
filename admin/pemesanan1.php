        ...
        <div class="pemesanan-tiket">
          ...
          <div class="pesan" style="margin-right: 150px;">
            <form>
              ...
              <input type="date" name="tgl_awal" id="tgl_awal" placeholder="Tanggal Perjalanan" min="<?php echo date('Y-m-d'); ?>" />
              <input type="date" name="tgl_akhir" id="tgl_akhir" placeholder="Tanggal Perjalanan" min="<?php echo date('Y-m-d'); ?>" />  
