        ...
        <div class="pemesanan-tiket">
          ...
          <div class="slideshow-container">
            <div class="mySlides fade">
              <img src="../jpg/Bromo Private Day Tour dengan Air Terjun Madakaripura.webp" style="width: 100%" />
            </div>
          ...
          <div class="pesan" style="margin-right: 150px;">
            <form>
              <h2>Bromo Private Day Tour dengan Air Terjun Madakaripura</h2>
              <br />
              ...
              <p class="prace" name="harga"><b>Rp 780.000/ days</b></p>
              <div class="pilih">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <h3>Detail Tour</h3>
    <div class="table">
        <img src="../jpg/Bromo Private Day Tour dengan Air Terjun Madakaripura.jpg" alt="" />
        <p class="pindul"><b>Bromo Private Day Tour dengan Air Terjun Madakaripura</b></p>
        <input type="text" name="destinasi" value ="Bromo Private Day Tour dengan Air Terjun Madakaripura" hidden readonly />
        <p class="location">
...
<tr>
  ...
  function populateCheckoutDetails() {
    ...
    if (tglAwalInput && tglAkhirInput && hargaInput) {
        ...
        let hargaPerHari = 780000; // Ganti dengan harga per hari yang sesuai
