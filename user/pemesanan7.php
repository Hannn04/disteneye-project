...
<html lang="en">
  <head>
    ...
    <title> Air Terjun Tumpaksewu Lumajang</title>
    <link
      rel="stylesheet"
        ...
        <div class="pemesanan-tiket">
          ...
          <div class="slideshow-container">
            <div class="mySlides fade">
              <img src="../jpg/Eksplorasi Air Terjun Tumpaksewu Lumajang.jpg" style="width: 100%" />
            </div>
          ...
          <div class="pesan" style="margin-right: 150px;">
            <form>
              <h2>Eksplorasi Air Terjun Tumpaksewu Lumajang</h2>
              <br />
              ...
              <p class="prace" name="harga"><b>Rp 260.000/ days</b></p>
              <div class="pilih">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <div class="table">
        ...
        <p class="pindul"><b>Eksplorasi Air Terjun Tumpaksewu Lumajang</b></p>
        <input type="text" name="destinasi" value ="Eksplorasi Air Terjun Tumpaksewu Lumajang" hidden readonly />
        <p class="location">
...
<tr>
  ...
  function populateCheckoutDetails() {
    ...
    if (tglAwalInput && tglAkhirInput && hargaInput) {
        ...
        let hargaPerHari = 260000; // Ganti dengan harga per hari yang sesuai
