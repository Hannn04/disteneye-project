...
<html lang="en">
  <head>
    ...
    />
    <link rel="stylesheet" href="../css/goaaaa.css" />
...
<tr>
    ...
    <td>
        ...
        <br />
        <div class="total">
        <strong>Total </strong><input class="price" type="text" name="hargaTotal" id="checkout-harga-total" readonly></input> 
        </div>
