...
<html lang="en">
  <head>
    ...
    <title>Wisata Alam Semarang</title>
    <link
      rel="stylesheet"
        ...
        <div class="pemesanan-tiket">
          ...
          <div class="slideshow-container">
            <div class="mySlides fade">
              <img src="../jpg/Wisata Alam Semarang Full Day by Paradiso Tour.webp" style="width: 100%" />
            </div>
          ...
          <div class="pesan" style="margin-right: 150px;">
            <form>
              <h2>Wisata Alam Semarang Full Day by Paradiso Tour</h2>
              <br />
              ...
              <p class="prace" name="harga"><b>Rp 195.000/ days</b></p>
              <div class="pilih">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <div class="table">
        ...
        <p class="pindul"><b>Wisata Alam Semarang Full Day by Paradiso Tour</b></p>
        <input type="text" name="destinasi" value ="Wisata Alam Semarang Full Day by Paradiso Tour" hidden readonly />
        <p class="location">
...
<tr>
  ...
  function populateCheckoutDetails() {
    ...
    if (tglAwalInput && tglAkhirInput && hargaInput) {
        ...
        let hargaPerHari = 195000; // Ganti dengan harga per hari yang sesuai
