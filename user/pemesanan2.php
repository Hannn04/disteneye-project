...
<html lang="en">
  <head>
    ...
    <title>Open Trip Explore Merapi</title>
    <link
      rel="stylesheet"
        ...
        <div class="pemesanan-tiket">
          ...
          <div class="slideshow-container">
            <div class="mySlides fade">
              <img src="../jpg/Explore Merapi.webp" style="width: 100%" />
            </div>

            <div class="mySlides fade">
              <img src="../jpg/explore3.jpg" style="width: 100%" />
            </div>
          ...
          <div class="pesan" style="margin-right: 150px;">
            <form>
              <h2>Open Trip Explore Merapi</h2>
              <br />
              ...
              <p class="prace" name="harga"><b>Rp 750.000/ days</b></p>
              <div class="pilih">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <div class="table">
        ...
        <p class="pindul"><b>Explore Merapi</b></p>
        <input type="text" name="destinasi" value ="Explore Merapi" hidden readonly />
        <p class="location">
...
<tr>
  ...
  function populateCheckoutDetails() {
    ...
    if (tglAwalInput && tglAkhirInput && hargaInput) {
        ...
        let hargaPerHari = 750000; // Ganti dengan harga per hari yang sesuai
