...
<html lang="en">
  <head>
    ...
    <title>Wisata Karimunjawa</title>
    <link
      rel="stylesheet"
        ...
        <div class="pemesanan-tiket">
          ...
          <div class="slideshow-container">
            <div class="mySlides fade">
              <img src="../jpg/Paket Wisata Karimunjawa.jpg" style="width: 100%" />
            </div>
          ...
          <div class="pesan" style="margin-right: 150px;">
            <form>
              ...
              <p class="prace" name="harga"><b>Rp 1.300.000/ days</b></p>
              <div class="pilih">
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        <div class="kotak">
          <div class="box">
            ...
            <div class="content">
              ...
              <a class="detail" href=""
                ><b>Paket Wisata Karimunjawa</b></a
              >
    ...
    <div class="table">
        ...
        <p class="pindul"><b>Paket Wisata Karimunjawa</b></p>
        <input type="text" name="destinasi" value ="Paket Wisata Karimunjawa" hidden readonly />
        <p class="location">
...
<tr>
  ...
  function populateCheckoutDetails() {
    ...
    if (tglAwalInput && tglAkhirInput && hargaInput) {
        ...
        let hargaPerHari = 1300000; // Ganti dengan harga per hari yang sesuai
