        ...
        <div class="pemesanan-tiket">
          ...
          <div class="slideshow-container">
            <div class="mySlides fade">
              <img src="../jpg/Kuta Mandalika Full Day Tour.jpg" style="width: 100%" />
            </div>
          ...
          <div class="pesan" style="margin-right: 150px;">
            <form>
              <h2>Kuta Mandalika Full Day Tour</h2>
              <br />
              ...
              <p class="prace" name="harga"><b>Rp 212.000/ days</b></p>
              <div class="pilih">
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        <div class="kotak">
          <div class="box">
            ...
            <div class="content">
              ...
              <a class="detail" href=""
                ><b>Kuta Mandalika Full Day Tour</b></a
              >
    ...
    <div class="table">
        ...
        <p class="pindul"><b>Kuta Mandalika Full Day Tour</b></p>
        <input type="text" name="destinasi" value ="Kuta Mandalika Full Day Tour" hidden readonly />
        <p class="location">
...
<tr>
  ...
  function populateCheckoutDetails() {
    ...
    if (tglAwalInput && tglAkhirInput && hargaInput) {
        ...
        let hargaPerHari = 212000; // Ganti dengan harga per hari yang sesuai
