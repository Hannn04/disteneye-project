...
<html lang="en">
  <head>
    ...
    <title>Canyoneering Curug Cikondang Cianjur</title>
    <link
      rel="stylesheet"
        ...
        <div class="pemesanan-tiket">
          ...
          <div class="slideshow-container">
            <div class="mySlides fade">
              <img src="../jpg/Canyoneering Curug Cikondang Cianjur.webp" style="width: 100%" />
            </div>
          ...
          <div class="pesan" style="margin-right: 150px;">
            <form>
              <h2>Canyoneering Curug Cikondang Cianjur</h2>
              <br />
              ...
              <p class="prace" name="harga"><b>Rp 500.000/ days</b></p>
              <div class="pilih">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <div class="table">
        ...
        <p class="pindul"><b>Canyoneering Curug Cikondang Cianjur</b></p>
        <input type="text" name="destinasi" value ="Canyoneering Curug Cikondang Cianjur" hidden readonly />
        <p class="location">
...
<tr>
  ...
  function populateCheckoutDetails() {
    ...
    if (tglAwalInput && tglAkhirInput && hargaInput) {
        ...
        let hargaPerHari = 450000; // Ganti dengan harga per hari yang sesuai
